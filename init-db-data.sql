...
(
    ...
    idCompte          INT NOT NULL,
    dateSolde         DATE NOT NULL,
    montantSolde      DECIMAL(12, 2) NOT NULL,
    dateHeureCreation TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
    CONSTRAINT FaitSoldeCompte_Compte_idCompte_fk
...
-- Triggers sur la table mouvement pour mettre à jour le solde du compte et historiser
DELIMITER //
...
BEGIN
    ...
    INSERT INTO FaitSoldeCompte(idCompte, dateSolde, montantSolde)
    VALUES (NEW.idCompte, NEW.dateMouvement, v_solde);
END//
DELIMITER ;
...
BEGIN
    ...
    INSERT INTO FaitSoldeCompte(idCompte, dateSolde, montantSolde)
    VALUES (OLD.idCompte, OLD.dateMouvement, v_solde);
END//
DELIMITER ;